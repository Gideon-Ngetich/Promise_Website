...
const GalleryBackground = () => {
  return (
    <div>
        <TopNav/>
      <div className="bg-cover bg-center sm:bg-fixed h-[400px] flex items-center justify-center" style={{backgroundImage: `url('https://www.foodiesfeed.com/wp-content/uploads/2023/06/pouring-honey-on-pancakes.jpg')`}}>
